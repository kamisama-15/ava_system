        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header bg-primary">
                    <h3 class="card-title">Add Grade 6 Student</h3>
                </div>
                <!-- /.card-header -->
                <div class="contaier col-12">
                    <form action="{{action('ElementaryController@insertGradeSixStudent')}}" method="POST" class="form-horizontal">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                        ...
                                        <div class="col-sm-9">
                                          <select class="form-control" name="gr_six_section_id" id="gr_six_section_id">
                                            ...
                                            @foreach ($gr_six_sections as $gr_six_section)
                                                <option value="{{$gr_six_section->gr_six_section_id}}">{{$gr_six_section->gr_six_section_name}} </option>
                                            @endforeach
                                          </select>
                                        </div>
                                    </div>
