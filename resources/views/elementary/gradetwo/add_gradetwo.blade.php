        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header bg-primary">
                    <h3 class="card-title">Add Grade 2 Student</h3>
                </div>
                <!-- /.card-header -->
                <div class="contaier col-12">
                    <form action="{{action('ElementaryController@insertGradeTwoStudent')}}" method="POST" class="form-horizontal">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                        ...
                                        <div class="col-sm-9">
                                          <select class="form-control" name="gr_two_section_id" id="gr_two_section_id">
                                            ...
                                            @foreach ($gr_two_sections as $gr_two_section)
                                                <option value="{{$gr_two_section->gr_two_section_id}}">{{$gr_two_section->gr_two_section_name}} </option>
                                            @endforeach
                                          </select>
                                        </div>
                                    </div>
