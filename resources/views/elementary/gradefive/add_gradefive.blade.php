        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header bg-primary">
                    <h3 class="card-title">Add Grade 5 Student</h3>
                </div>
                <!-- /.card-header -->
                <div class="contaier col-12">
                    <form action="{{action('ElementaryController@insertGradeFiveStudent')}}" method="POST" class="form-horizontal">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                      ...
                                      <div class="col-sm-9">
                                        <select class="form-control" name="gr_five_section_id" id="gr_five_section_id">
                                          ...
                                          @foreach ($gr_five_sections as $gr_five_section)
                                              <option value="{{$gr_five_section->gr_five_section_id}}">{{$gr_five_section->gr_five_section_name}} </option>
                                          @endforeach
                                        </select>
                                      </div>
                                  </div>
