        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-header bg-primary">
                    <h3 class="card-title">Add Grade 1 Student</h3>
                </div>
                <!-- /.card-header -->
                <div class="contaier col-12">
                    <form action="{{action('ElementaryController@insertGradeOneStudent')}}" method="POST" class="form-horizontal">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                        ...
                                        <div class="col-sm-9">
                                          <select class="form-control" name="gr_one_section_id" id="gr_one_section_id">
                                            ...
                                            @foreach ($gr_one_sections as $gr_one_section)
                                                <option value="{{$gr_one_section->gr_one_section_id}}">{{$gr_one_section->gr_one_section_name}} </option>
                                            @endforeach
                                          </select>
                                        </div>
                                    </div>
