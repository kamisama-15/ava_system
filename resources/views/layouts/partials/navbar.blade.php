<nav class="main-header navbar navbar-expand navbar-primary">
    ...
    {{--  
       ...
       @endif --}}
        ...
        <li class="nav-item dropdown ">
            <a class="nav-link text-light btn btn-dark" data-toggle="dropdown" href="#"><i class="far fa-user-circle"></i>   {{ Auth::user()->name }} <i class="fas fa-caret-down"></i></a>
            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                <span class="dropdown-item dropdown-header">Account Management</span>
                <div class="dropdown-divider"></div>
                <a href="{{action('UserController@main')}}" class="dropdown-item">
